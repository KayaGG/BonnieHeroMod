...
namespace BonnieHeroMod
{
    public static class BonnieLogic
    {
        ...
        {
            if (TowerSelectionMenu.instance.selectedTower.tower.GetBonnieData(out var towerLogic) && towerLogic.CurrentTier < BonnieData.GetMaxTier(
        ...
        {
            InGame.instance.SetCash(InGame.instance.GetCash() + towerLogic.SellAmount);
            towerLogic.SellAmount = 0; //set "bank" to 0
